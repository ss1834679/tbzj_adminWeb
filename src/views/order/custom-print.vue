  ...
  <div id="custom-print">
    ...
    <el-card class="box-card" shadow="never">
      ...
      <el-table :data="afterSaleList" border row-key="id" style="width: 100%" @selection-change="getSelection">
        ...
        <el-table-column prop="sn" label="发货人">
        </el-table-column>
        <el-table-column prop="userNum" label="内容"></el-table-column>
        <el-table-column label="操作" align="center">
          <template slot-scope="">
            <el-button type="text" size="medium" @click="viewOrder({type:'open'})">编辑</el-button>
            <!-- 每一个阶段 不同的操作 已取消 -->
      ...
      <!-- 编辑弹窗框 -->
      <el-dialog title="添加退货原因" :visible.sync="closeVisible" style="width:70%">
        <el-form :model="form2" ref="form2" label-width="100px" class="demo-dynamic">
         <div style="width:80%">
          ...
          <div style="width:80%">
            ...
            <el-input v-model="form2.textarea"   type="textarea" :rows="6"></el-input>
          </el-form-item>
          </div>
        </el-form>
