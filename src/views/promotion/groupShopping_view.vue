    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="content">
        <el-form label-width="100px">
          ...
          <el-form-item label="成团人数">{{goodsform.assemblePersonNum}}人</el-form-item>
          <el-form-item label="历史限购">{{goodsform.historyLimit}}次</el-form-item>
          <el-form-item label="成团倒计时">{{goodsform.assembleCountDown}}小时</el-form-item>
          <el-form-item label="新人参团">{{goodsform.isNewPerson?'是':'否'}}</el-form-item>
          <el-form-item label="展示拼团价">{{"¥"+(goodsform.goodsMarketPrice/100).toFixed(2)}}</el-form-item>
...
import { getAssembleGoodsById } from "../../api/promotion";
export default {
  data() {
    return {
      goodsform: {
  ...
  beforeMount() {
    getAssembleGoodsById(this.$route.query.id).then(data => {
