      ...
      <div class="content">
        ...
        <el-form :model="goodsform" ref="goodsform" :rules="goodsRules" label-width="120px" class="demo-ruleForm">
          ...
          <div class="steps" v-show="active==2">
            ...
            <el-form-item label="编辑规格:" class="editOptional">
...
import { insertGoodBySup } from "../../api/supplier";
import { getGoodsList, getGoodsStyleByCategoryId } from "../../api/good";
        ...
        if (valid) {
          new Promise((resolve, reject) => {
            ...
            .then(() => {
              ...
              insertGoodBySup(this.goodsform).then(data => {
                if (data.data.status == 0) {
                  this.$message({
                    showClose: true,
                    message: "添加成功",
