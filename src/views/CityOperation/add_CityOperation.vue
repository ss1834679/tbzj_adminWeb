  ...
  <div id="add_CityOperation">
    ...
    <el-card class="box-card" shadow="never">
      <div slot="header" class="clearfix">
        <span class="title">添加城市运营中心</span>
        <div>
        ...
        <el-form :model="CityOperationForm" ref="CityOperationForm" :rules="cityOperationRules" label-width="150px" class="demo-ruleForm">
          ...
          <el-form-item label="logo" prop="logoImage">
            <upload-img
              ...
              :imgArr="this.CityOperationForm.logoImage"
              :limit="1"
          ...
          <el-form-item label="电话：" prop="mobile">
            <el-input v-model="CityOperationForm.mobile" @blur="blueText" style="width:300px"></el-input>
          </el-form-item>
          ...
          <el-form-item label="关联案例" class="relatGoods">
            ...
            <el-table :data="relatedProList" style="width: 800px" border>
              <el-table-column prop="title" label="商品名称" width="400px"></el-table-column>
              <el-table-column label="操作">
                <template slot-scope="scope">
...
<script>
import { saveOrUpdateBusinessCenter } from "../../api/cityOperation";
